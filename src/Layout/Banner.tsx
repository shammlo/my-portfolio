      ...
      <Wrapper class="container">
        ...
        <Wrapper class="flex content-start flex-col lgm:flex-row">
          <Wrapper class="banner-left banner-text flex-1 pb-16 lgm:pt-[6rem]">
            <Wrapper class="banner-text text-center lgm:text-left" animation="fade-right">
              <h1 className="banner-text-title my-3">
                ...
                <strong className="c-name relative"> Shamlo</strong>, I&apos;m a Full Stack
                Engineer!
              </h1>
              <h2 className="banner-text-subtitle mb-8 mt-4">
                A self-taught full-stack engineer and web designer based in Kurdistan.
              </h2>
            </Wrapper>
            {/* //-------------------------------------------- */}
            {/* //- <! -- Download CV -->*/}
              ...
              <Wrapper class="banner-contact max-h-[42px] max-w-[170px]">
                ...
                >
                  ...
                  <div className="flex items-center justify-center text-white  h-[42px] w-[40px]">
                    <svg className="contact-icon " x="2.5rem" y="2.5rem" viewBox="0 0 474 474">
                      <g>
            ...
            {/* //-Social links */}
            <Wrapper class="banner-socials mt-12" ariaLabel="Social Links" animation="fade-right">
              <a
